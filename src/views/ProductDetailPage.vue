            ...
            <div class="flex flex-col my-4 text-left max-w-xl">
              ...
              <div class="flex flex-col gap-1 mb-6">
                ...
                <p class="text-md mt-1">
                  Syrup GENOVA Hazelnut 750 ML Syrup Hazelnut GENOVA adalah
                  salah satu dari tiga rasa flavour kopi spesial teratas,
                  bersama dengan vanilla dan karamel, sirup GENOVA Hazelnut
                  menghadirkan rasa dan aroma hazelnut yang segar dengan
                  sentuhan almond dan vanilla
                </p>
              </div>
