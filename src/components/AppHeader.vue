          ...
          >
            ...
            >
              <div @click="selectResult(product)" @mousedown.prevent>
                ...
                >
                  <div class="cursor-pointer" @click="clickSearchBar()">
                    {{ product.name }}
                  </div>
                </router-link>
              </div>
    ...
    return {
      ...
      products: [
        ...
        },
        {
          ...
          tasting:
            "Awal: Karamel yang intens dengan nada bulat dari permen karamel, Tengah: Kaya dan rasa krim dengan nada asin, Panjang di mulut: karamel mentega asin",
        },
        {
          id: 31,
          name: "Syrup Coconut",
        ...
        },
        {
          ...
          color: "Emas",
          tasting:
            "Awal: Kacang segar dan bunga, Tengah: Rasa hazelnut segar dan nabati, Panjang di Mulut: Sentuhan halus almond dan vanila",
        },
        {
          id: 35,
          name: "Syrup Irish",
