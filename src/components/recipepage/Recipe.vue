      ...
      <div class="flex flex-col gap-8 px-12 md:px-0">
        ...
        >
          <div class="max-w-xs w-20">
            <h3 class="text-xl md:text-2xl mb-4">Ice Shakes</h3>
          </div>
          <div
          ...
          >
            <!-- Item 1 -->
            <div
              class="flex flex-col items-center justify-center px-1 py-2 gap-3 w-24 lg:w-28 h-32 md:h-44"
            >
              <img
              ...
              <div class="flex flex-col items-center gap-1 h-full">
                <h2
                  class="text-lg lg:text-xl h-full md:h-14 lg:h-9 tracking-tight"
                >
                  Powder
                </h2>
                <p class="text-lg lg:text-xl text-gray-600 h-full md:h-8">
                  30gr
                </p>
              </div>
            </div>
        ...
        >
          <div class="max-w-xs w-20">
            <h3 class="text-xl md:text-2xl mb-4">Ice Blended</h3>
          </div>
          <div
            class="flex flex-col items-center px-2 py-3 md:px-4 md:py-5 center md:flex-row md:gap-0 gap-1 lg:gap-1 xl:gap-5"
          >
        ...
        >
          <div class="max-w-xs w-20">
            <h3 class="text-xl md:text-2xl mb-4">Mocktail</h3>
          </div>
          <div
            class="flex flex-col items-center px-2 py-3 md:px-4 md:py-5 center md:flex-row md:gap-0 gap-1 lg:gap-1 xl:gap-5"
          >
        ...
        >
          <div class="max-w-xs w-20">
            <h3 class="text-xl md:text-2xl mb-4">Fruit Smoothies</h3>
          </div>
          <div
            class="flex flex-col items-center px-2 py-3 md:px-4 md:py-5 center md:flex-row md:gap-0 gap-1 lg:gap-1 xl:gap-5"
          >
        ...
        >
          <div class="max-w-xs w-20">
            <h3 class="text-xl md:text-2xl mb-4">Special Tea</h3>
          </div>
          <div
            class="flex flex-col items-center px-2 py-3 md:px-4 md:py-5 center md:flex-row md:gap-0 gap-1 lg:gap-1 xl:gap-5"
          >
